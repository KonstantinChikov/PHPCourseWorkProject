    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 pt-3">
                <div class="card">
                    <h5 class="card-header">{{ __('Add New Type') }}</h5>
                    <div class="card-body">
                        <form method="POST" action="{{route('type.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea cols="35" rows="5" id="amenities" type="text"
                                              class="form-control @error('amenities') is-invalid @enderror"
                                              name="amenities"
                                              value="{{ old('amenities') }}" required autocomplete="amenities"></textarea>
                                    @error('amenities')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
